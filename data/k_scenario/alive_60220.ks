;//¡ƒuƒƒbƒN‚U‚O‚Q‚Q‚OFw’EoŒv‰æ‚Qx
*alive_60220_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤alive_60220'"]
;[debug_win_end]
;<SceneSet ’EoŒv‰æ‚Q>
...
;//š‚a‚fFƒyƒbƒgƒVƒ‡ƒbƒvAi“_“”j
;Á‚µ
[bg storage="bg22a"][trans_c cross time=1000]

;êŠ<ImageLoad 6,place09.bmp><ImagePos 6,1000,5>
...
;//š‚a‚fFƒtƒLƒkƒP•t‹ß‚R‚eAi“_“”j
;Á‚µ
