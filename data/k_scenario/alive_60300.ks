;//¡ƒuƒƒbƒN‚U‚O‚R‚O‚OFwŠy‰€x
*alive_60300_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤alive_60300'"]
;[debug_win_end]
;<SceneSet Šy‰€>
...
;ƒtƒ[[eval exp="sf.g_Alive_confusion = 1"]
...
;//YAlive_TED
;ƒtƒ[[eval exp="sf.g_flow_alive = 1"]
