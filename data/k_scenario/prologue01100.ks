;//¡ƒuƒƒbƒN‚O‚P‚P‚O‚OFwˆÚ“®’†x
;//cƒAƒtƒŒƒR‚Ì’ˆÓA‚Ü‚½‚Íw¦
;//¦‚±‚ÌƒuƒƒbƒN‚Í‘ÌŒ±”Å‚ÌƒXƒNƒŠƒvƒg‚ğ—¬—p‚µ‚Ä‰º‚³‚¢

*prologue01100_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤prologue01100'"]
;[debug_win_end]
;<SceneSet ˆÚ“®’†>
...
[vo_hay s="hayami0061"]
[ns]Arisu[nse]
"Hey, Tak-kun, give me that, pleaseô"[pcms]
...
[vo_hay s="hayami0062"]
[ns]Arisu[nse]
"That looks good~ I want to eat some tooô"[pcms]
...
[vo_hay s="hayami0063"]
[ns]Arisu[nse]
"Ah, Miku~, that looks deliciousô"[pcms]
