;//¡ƒuƒƒbƒN‚Q‚O‚S‚V‚OFwAspectSwitch‚P‚Qx

*westtown_zap_20470_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤westtown_zap_20470'"]
;[debug_win_end]
...
[jump storage="westtown_zap_20480.ks" target=*westtown_zap_20480_TOP]
