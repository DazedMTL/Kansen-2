;//Å°ÉuÉçÉbÉNÇRÇOÇPÇTÇOÅFÅwParadise Lost_partÇTÅx

*westtown_bad_30150_TOP
;[debug_win]
;[eval exp="f.nowfile = 'Ç»Ç§westtown_bad_30150'"]
;[debug_win_end]
;//;<SceneSet ÇoÇ`ÇqÇ`ÇcÇhÇrÇdÅ@ÇkÇnÇrÇsÅ@ÇoÇ`ÇqÇsÇT>
...
;//ÅóÅFìåìèÅEâÆè„
;//ÅöÇaÇfÅFâÆè„ÅEìWñ]ë‰ìåCÅiñÈÅj
;è¡Çµ
[bg storage="bg21c"][trans_c cross time=1000]

;èÍèä<ImageLoad 6,place16.bmp><ImagePos 6,1000,5>
...
;//ÅÙÅFîMçª_Extreme.wav
[bgm storage="îMçª_Extreme"]
...
;//ÅÙÅFîMçª_Extreme.wav fadeOUT

[fadeoutbgm time=1000]
[stop_se0]
[sysbt_meswin clear]
;è¡Çµñ≥Çµ[chara_int_ layer=][chara_int_ layer=5]
