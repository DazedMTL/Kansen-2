;//¡ƒuƒƒbƒN‚U‚O‚Q‚T‚OFw’ÇŒ‚x
*alive_60250_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤alive_60250'"]
;[debug_win_end]
;<SceneSet ’ÇŒ‚>
...
[vo_hay s="hayami1212"]
[ns]Arisu[nse]
"Ah~ô There are so many people~... Is there some kind of[r]
event~?"[pcms]
...
[vo_hay s="hayami1213"]
[ns]Arisu[nse]
"Everyone is coming this way~ô Hey~! Ahaha! Are you going to[r]
include us too~!?"[pcms]
