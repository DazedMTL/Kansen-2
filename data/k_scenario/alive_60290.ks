;//¡ƒuƒƒbƒN‚U‚O‚Q‚X‚OFw¸Šy‰€x
*alive_60290_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤alive_60290'"]
;[debug_win_end]
;<SceneSet ¸Šy‰€>
