...
*jingujiroute12220_TOP
;[debug_win]
;[eval exp="f.nowfile = 'なうjingujiroute12220'"]
;[debug_win_end]
;<SceneSet 空腹>

;//〆jin-TED
;//ブロック１２２２０
;フロー[eval exp="sf.g_jin_TED = 1"]
;//4になるかも
...
;消し
[black_toplayer][trans_c cross time=1000][hide_chara_int]
[bg storage="bg400b" x=-400 y=0][trans_c blind_lr time=500]
...
;//神宮司ルートノーマルエンディング
[movie storage="jinguji_normalend.mpg"]
