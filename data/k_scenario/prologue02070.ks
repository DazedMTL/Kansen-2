;//¡ƒuƒƒbƒN‚O‚Q‚O‚V‚OFw’‰Œ¢x
;//cƒAƒtƒŒƒR‚Ì’ˆÓA‚Ü‚½‚Íw¦
;//¦‚±‚ÌƒuƒƒbƒN‚Í‘ÌŒ±”Å‚ÌƒXƒNƒŠƒvƒg‚ğ—¬—p‚µ‚Ä‰º‚³‚¢

*prologue02070_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤prologue02070'"]
;[debug_win_end]
;<SceneSet ’‰Œ¢>
...
;//ôF‚O‚O‚T_Rapture@ƒtƒF[ƒhƒAƒEƒg
[fadeoutbgm time=1000]
...
;//ôF‚O‚O2_Š´õ Extreme@Ver.@ƒtƒF[ƒhƒCƒ“
;//ôFbgm009
[bgm storage="bgm009"]
