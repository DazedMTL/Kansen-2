...
[eval exp="tf.onoff_x = [sf.conf_bgm_onoff_x,sf.conf_se_onoff_x,sf.conf_vo1_onoff_x,sf.conf_vo2_onoff_x,sf.conf_vo3_onoff_x,sf.conf_vo4_onoff_x,sf.conf_vo5_onoff_x,sf.conf_vo6_onoff_x,sf.conf_vo7_onoff_x]" cond="tf.onoff_x === void"]
[eval exp="tf.onoff_y = [sf.conf_bgm_onoff_y,sf.conf_se_onoff_y,sf.conf_vo1_onoff_y,sf.conf_vo2_onoff_y,sf.conf_vo3_onoff_y,sf.conf_vo4_onoff_y,sf.conf_vo5_onoff_y,sf.conf_vo6_onoff_y,sf.conf_vo7_onoff_y]" cond="tf.onoff_y === void"]
...
; サウンドスライダーの座標を配列で用意
[eval exp="tf.cnf_srdsnd_x = [sf.conf_srd_bgm_x,sf.conf_srd_se_x,sf.conf_srd_vo1_x,sf.conf_srd_vo2_x,sf.conf_srd_vo3_x,sf.conf_srd_vo4_x,sf.conf_srd_vo5_x,sf.conf_srd_vo6_x,sf.conf_srd_vo7_x]" cond="tf.cnf_srdsnd_x === void"]
[eval exp="tf.cnf_srdsnd_y = [sf.conf_srd_bgm_y,sf.conf_srd_se_y,sf.conf_srd_vo1_y,sf.conf_srd_vo2_y,sf.conf_srd_vo3_y,sf.conf_srd_vo4_y,sf.conf_srd_vo5_y,sf.conf_srd_vo6_y,sf.conf_srd_vo7_y]" cond="tf.cnf_srdsnd_y === void"]
...
[if exp="sf.config_1st != 1"]
	...
	;現在の値をダミーフラグに入れ
	[eval exp="sf.dummy_seopt4  = kag.se[4].volume2"  cond="sf.bt_num_chara01 != void"]
	[eval exp="sf.dummy_seopt6  = kag.se[6].volume2"  cond="sf.bt_num_chara02 != void"]
	[eval exp="sf.dummy_seopt8  = kag.se[8].volume2"  cond="sf.bt_num_chara03 != void"]
	[eval exp="sf.dummy_seopt10 = kag.se[10].volume2" cond="sf.bt_num_chara04 != void"]
	[eval exp="sf.dummy_seopt12 = kag.se[12].volume2" cond="sf.bt_num_chara05 != void"]
	[eval exp="sf.dummy_seopt14 = kag.se[14].volume2" cond="sf.bt_num_chara06 != void"]
	[eval exp="sf.dummy_seopt16 = kag.se[16].volume2" cond="sf.bt_num_chara07 != void"]
...
[eval exp="kag.autoModePageWait = kag.autoModePageWaits.medium"]
	...
	;[resetfont]
	;こうか？要検証 一応動くけど今回は見送り
;	[eval exp="sf.userfont = 'ＭＳ Ｐ明朝'"]
;	[eval exp="kag.chDefaultFace  = 'ＭＳ Ｐ明朝'"]
...
;	[eval exp="kag.setMessageLayerUserFont()"]
	...
	;ボイス
	[seopt buf=4  gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara01 != void"]
	[seopt buf=6  gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara02 != void"]
	[seopt buf=8  gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara03 != void"]
	[seopt buf=10 gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara04 != void"]
	[seopt buf=12 gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara05 != void"]
	[seopt buf=14 gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara06 != void"]
	[seopt buf=16 gvolume="&sf.CHARA_defvolume" cond="sf.bt_num_chara07 != void"]
...
;	[seopt buf=11 gvolume="&sf.BGV_defvolume"]
	...
	[eval exp="sf.chara06_v = 1" cond="sf.bt_num_chara06 != void"]
	[eval exp="sf.chara07_v = 1" cond="sf.bt_num_chara07 != void"]
