...
[macro name=sel01]
	...
	[ptext face="ＭＳ Ｐ明朝"  layer="&sf.layer_seltext+1" page=fore x="&sf.seltext1_x" y="&sf.selold_y[1] + sf.sel_text_mt" size="&sf.seltext_size" color=0xffffff shadow=true edge=true edgecolor=0x000000 bold=true text="&f.seltext01"]
...
[macro name=sel02]
	...
	[ptext face="ＭＳ Ｐ明朝"  layer="&sf.layer_seltext+2" page=fore x="&sf.seltext2_x" y="&sf.selold_y[2] + sf.sel_text_mt" size="&sf.seltext_size" color=0xffffff shadow=true edge=true edgecolor=0x000000 bold=true text="&f.seltext02"]
...
[macro name=sel03]
	...
	[ptext face="ＭＳ Ｐ明朝"  layer="&sf.layer_seltext+3" page=fore x="&sf.seltext3_x" y="&sf.selold_y[3] + sf.sel_text_mt" size="&sf.seltext_size" color=0xffffff shadow=true edge=true edgecolor=0x000000 bold=true text="&f.seltext03"]
...
[macro name=sel04]
	...
	[ptext face="ＭＳ Ｐ明朝"  layer="&sf.layer_seltext+4" page=fore x="&sf.seltext4_x" y="&sf.selold_y[4] + sf.sel_text_mt" size="&sf.seltext_size" color=0xffffff shadow=true edge=true edgecolor=0x000000 bold=true text="&f.seltext04"]
...
[macro name=sel05]
	...
	[ptext face="ＭＳ Ｐ明朝"  layer="&sf.layer_seltext+5" page=fore x="&sf.seltext5_x" y="&sf.selold_y[5] + sf.sel_text_mt" size="&sf.seltext_size" color=0xffffff shadow=true edge=true edgecolor=0x000000 bold=true text="&f.seltext05"]
...
[macro name=sel06]
	...
	[ptext face="ＭＳ Ｐ明朝"  layer="&sf.layer_seltext+6" page=fore x="&sf.seltext6_x" y="&sf.selold_y[6] + sf.sel_text_mt" size="&sf.seltext_size" color=0xffffff shadow=true edge=true edgecolor=0x000000 bold=true text="&f.seltext06"]
