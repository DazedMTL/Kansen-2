...
[macro name=射精フラB]
	; エフェクトがオンなら射精フラ
	[if exp="sf.efect == 1"]
		[backlay][image storage="chara_int" layer="&sf.effectlayer" page=back visible=true left=0 top=0 opacity=255][trans time=1000 method=crossfade][wt_c]
	[endif]
...
;		[trans method=universal rule="LtoR" vague=100 time=%time|500][wt_c]
		[trans method=universal rule="イメージクロスα左から" vague=100 time=%time|500][wt_c]
	[elsif exp="mp.rl"]
;		[trans method=universal rule="RtoL" vague=100 time=%time|500][wt_c]
		[trans method=universal rule="イメージクロスα右から" vague=100 time=%time|500][wt_c]
	[elsif exp="mp.tb"]
;		[trans method=universal rule="TtoB" vague=300 time=%time|500][wt_c]
		[trans method=universal rule="イメージクロスα上から" vague=300 time=%time|500][wt_c]
	[elsif exp="mp.bt"]
;		[trans method=universal rule="BtoT" vague=300 time=%time|500][wt_c]
		[trans method=universal rule="イメージクロスα下から" vague=300 time=%time|500][wt_c]
	[elsif exp="mp.wipe"]
