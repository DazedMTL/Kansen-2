...
[eval exp="sf.effectlayer = 9"]
;↑これ&sf.toplayerトップレイヤと同じになってね？
;effectエロ用
;[eval exp="sf.effectlayerH = 13"]
[eval exp="sf.effectlayerH = 9"]
;↑これも上すぎてあぶないから9にしておくか
...
;	[seopt buf=11 gvolume="&sf.BGV_defvolume"]
	...
	[seopt buf=14 gvolume="&sf.CHARA_defvolume"]
	[seopt buf=16 gvolume="&sf.CHARA_defvolume"]
