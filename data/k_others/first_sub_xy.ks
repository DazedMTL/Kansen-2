...
;===========================================================
;アスペクトボタン　配列は使えないようだ
[eval exp="sf.aspect1_x = 40"][eval exp="sf.aspect2_x = 440"]
	[eval exp="sf.aspect3_x = 330"]
[eval exp="sf.aspect1_y = 75"]
[eval exp="sf.aspect2_y = 195"]
[eval exp="sf.aspect3_y = 315"]
[eval exp="sf.aspect4_y = 435"]
	[eval exp="sf.aspect5_y = 520"]

[eval exp="sf.asp速水_x = sf.aspect1_x , sf.asp速水_y = sf.aspect1_y"][eval exp="sf.asp神宮_x = sf.aspect2_x , sf.asp神宮_y = sf.aspect1_y"]
[eval exp="sf.asp長崎_x = sf.aspect1_x , sf.asp長崎_y = sf.aspect2_y"][eval exp="sf.asp安西_x = sf.aspect2_x , sf.asp安西_y = sf.aspect2_y"]
[eval exp="sf.asp鶴田_x = sf.aspect1_x , sf.asp鶴田_y = sf.aspect3_y"][eval exp="sf.asp小林_x = sf.aspect2_x , sf.asp小林_y = sf.aspect3_y"]
[eval exp="sf.asp菅生_x = sf.aspect1_x , sf.asp菅生_y = sf.aspect4_y"][eval exp="sf.aspほか_x = sf.aspect2_x , sf.aspほか_y = sf.aspect4_y"]
[eval exp="sf.aspやめ_x = sf.aspect3_x , sf.aspやめ_y = sf.aspect5_y"]
...
[eval exp="tf.bgmTitle = 'bgm007'"]

;マス目の座標を作る
[eval exp="tf.T_bt_x = []"]
[eval exp="tf.T_bt_xadd = 220"]
...
[eval exp="tf.T_bt_y = []"]
[eval exp="tf.T_bt_yadd = 40"]
[eval exp="tf.T_bt_y[0] = 470"]
...
;-------------------タイトル画面-------------------
;ゲーム開始
[eval exp="sf.T_newgame_x = tf.T_bt_x[0]+30"]
[eval exp="sf.T_newgame_y = tf.T_bt_y[0]"]

;ロード
[eval exp="sf.T_load_x = tf.T_bt_x[1]+75"]
[eval exp="sf.T_load_y = tf.T_bt_y[0]"]

;クイックロード
[eval exp="sf.T_Qload_x = tf.T_bt_x[2]+100"]
[eval exp="sf.T_Qload_y = tf.T_bt_y[0]"]


	;プロローグスキップ
;	[eval exp="sf.T_pski_x = tf.T_bt_x[2]+110"]
;	[eval exp="sf.T_pski_y = tf.T_bt_y[0]+10"]

[eval exp="sf.T_rootW_x = tf.T_bt_x[0]+120"]
[eval exp="sf.T_rootW_y = tf.T_bt_y[1]"]

;[eval exp="sf.T_rootE_x = tf.T_bt_x[1]+50"]
;[eval exp="sf.T_rootE_y = tf.T_bt_y[1]-10"]

[eval exp="sf.T_rootA_x = tf.T_bt_x[2]+0"]
[eval exp="sf.T_rootA_y = tf.T_bt_y[1]"]



;コンフィグ
[eval exp="sf.T_conf_x = tf.T_bt_x[0]+65"]
[eval exp="sf.T_conf_y = tf.T_bt_y[2]"]

 
;アペンドエクストラ
[eval exp="sf.T_extra_x = tf.T_bt_x[1]+80"]
[eval exp="sf.T_extra_y = tf.T_bt_y[2]"]


;ゲーム終了
[eval exp="sf.T_quit_x = tf.T_bt_x[3]-50"]
[eval exp="sf.T_quit_y = tf.T_bt_y[2]"]
...
;CG Gallery
[eval exp="sf.T_cg_x = tf.T_bt_x[0]+10"]
[eval exp="sf.T_cg_y = tf.T_bt_y[1]-5"]

;Scene Replay
[eval exp="sf.T_sr_x = tf.T_bt_x[1]+50"]
[eval exp="sf.T_sr_y = tf.T_bt_y[1]-5"]

;BGM MOde
[eval exp="sf.T_bgm_x = tf.T_bt_x[2]+100"]
[eval exp="sf.T_bgm_y = tf.T_bt_y[1]-5"]

;return
[eval exp="sf.T_rt_x = tf.T_bt_x[1]+100"]
[eval exp="sf.T_rt_y = tf.T_bt_y[2]"]
...
[eval exp="sf.bt_num_chara07     = 20"]
[eval exp="sf.bt_num_v_stop      = 21"]
[eval exp="sf.bt_num_v_autowait  = 22"]
...
; サンプルウィンドウ文字列
[eval exp="sf.kidoku_sampletext = ' 姦染２ ―淫罪都市―'"]
...
[eval exp="sf.bgm01_ogg  = 'bgm004.ogg'"]
...
;BGM 2個目ogg
[eval exp="sf.bgm02_ogg  = 'bgm005.ogg'"]
...
;BGM 3個目ogg
[eval exp="sf.bgm03_ogg  = 'bgm009.ogg'"]
...
;BGM 4個目ogg
[eval exp="sf.bgm04_ogg  = 'bgm010.ogg'"]
...
;BGM 5個目ogg
[eval exp="sf.bgm05_ogg  = 'bgm011.ogg'"]
...
;BGM 6個目ogg
[eval exp="sf.bgm06_ogg  = 'bgm012.ogg'"]
...
;BGM 7個目ogg
[eval exp="sf.bgm07_ogg  = 'bgmED001.ogg'"]
...
;BGM 14個目ogg
[eval exp="sf.bgm14_ogg  = '熱砂_Extreme.ogg'"]
...
;BGM 15個目ogg
[eval exp="sf.bgm15_ogg  = 'bgm018.ogg'"]
