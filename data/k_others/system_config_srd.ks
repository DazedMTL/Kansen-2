...
[if exp="sf.chara06_v == 1"]
	[slider_create name=chvolume06 parentlayer="&tf.config_message" parentpage=fore left="&tf.cnf_srdsnd_x[0]" top="&tf.cnf_srdsnd_y[7]" visible=true min=0 max=100 position="&kag.se[14].volume2\1000" onchangefunc="sevolume_func14"]
[else]
	;つじつま合わせ
	[if exp="sf.dummy_seopt14 <=100"]
		[eval exp="sf.dummy_seopt14 = sf.dummy_seopt14*1000"]
	[endif]
	[slider_create name=chvolume06 parentlayer="&tf.config_message" parentpage=fore left="&tf.cnf_srdsnd_x[0]" top="&tf.cnf_srdsnd_y[7]" visible=true min=0 max=100 position="&sf.dummy_seopt14\1000" onchangefunc="dummy_seopt14"]
[endif]
[return]
...
[call storage="slider_control_snd.ks"]
[if exp="sf.chara06_v == 1"]
	[slider_create name=chvolume07 parentlayer="&tf.config_message" parentpage=fore left="&tf.cnf_srdsnd_x[0]" top="&tf.cnf_srdsnd_y[8]" visible=true min=0 max=100 position="&kag.se[16].volume2\1000" onchangefunc="sevolume_func16"]
[else]
	;つじつま合わせ
	[if exp="sf.dummy_seopt16 <=100"]
		[eval exp="sf.dummy_seopt16 = sf.dummy_seopt16*1000"]
	[endif]
	[slider_create name=chvolume07 parentlayer="&tf.config_message" parentpage=fore left="&tf.cnf_srdsnd_x[0]" top="&tf.cnf_srdsnd_y[8]" visible=true min=0 max=100 position="&sf.dummy_seopt16\1000" onchangefunc="dummy_seopt16"]
[endif]
[return]
