...
;[eval exp="sf.ksLabelSys_tmpload = (kag.currentLabel)"]
	...
	[ws buf=4  canskip=true cond="kag.autoMode && sf.v_autowait && sf.bt_num_chara01 != void"]
	[ws buf=6  canskip=true cond="kag.autoMode && sf.v_autowait && sf.bt_num_chara02 != void"]
	[ws buf=8  canskip=true cond="kag.autoMode && sf.v_autowait && sf.bt_num_chara03 != void"]
	[ws buf=10 canskip=true cond="kag.autoMode && sf.v_autowait && sf.bt_num_chara04 != void"]
	[ws buf=12 canskip=true cond="kag.autoMode && sf.v_autowait && sf.bt_num_chara05 != void"]
	[ws buf=14 canskip=true cond="kag.autoMode && sf.v_autowait && sf.bt_num_chara06 != void"]
...
;ボイスカットオンなら改ページ時にそれぞれのバッファを停止
	[if exp="sf.v_stop"]
		...
		[fadeoutse buf=4  time=200 cond="sf.bt_num_chara01 != void"]
		[fadeoutse buf=6  time=200 cond="sf.bt_num_chara02 != void"]
		[fadeoutse buf=8  time=200 cond="sf.bt_num_chara03 != void"]
		[fadeoutse buf=10 time=200 cond="sf.bt_num_chara04 != void"]
		[fadeoutse buf=12 time=200 cond="sf.bt_num_chara05 != void"]
		[fadeoutse buf=14 time=200 cond="sf.bt_num_chara06 != void"]
		[fadeoutse buf=16 time=200 cond="sf.bt_num_chara07 != void"]
	[endif]
