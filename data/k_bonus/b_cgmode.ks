...
;デバッグ用
;[eval exp="sf.HEV001 = 1"]
;[eval exp="sf.HEV001a = 1"]
;[eval exp="sf.HEV001b = 1"]
;[eval exp="sf.HEV001c = 1"]
;[eval exp="sf.HEV002 = 1"]
;[eval exp="sf.HEV004 = 1"]
;[eval exp="sf.HEV004a = 1"]
;[eval exp="sf.HEV004b = 1"]
;[eval exp="sf.HEV004f = 1"]

;[eval exp="sf.HEV003 = 1"]
;[eval exp="sf.HEV101 = 1"]
;[eval exp="sf.HEV102 = 1"]
;[eval exp="sf.HEV104 = 1"]
;[eval exp="sf.HEV301 = 1"]
;[eval exp="sf.HEV302 = 1"]
;[eval exp="sf.HEV303 = 1"]
;[eval exp="sf.HEV304 = 1"]
;[eval exp="sf.HEV305 = 1"]
;[eval exp="sf.HEV306 = 1"]
;[eval exp="sf.HEV307 = 1"]
;[eval exp="sf.HEV308 = 1"]
;[eval exp="sf.HEV309 = 1"]
;[eval exp="sf.HEV310 = 1"]
;[eval exp="sf.HEV311 = 1"]
;[eval exp="sf.HEV312 = 1"]
;[eval exp="sf.HEV313 = 1"]
;[eval exp="sf.HEV314 = 1"]
;[eval exp="sf.HEV201 = 1"]
;[eval exp="sf.HEV202 = 1"]
;[eval exp="sf.HEV203 = 1"]
;[eval exp="sf.HEV204 = 1"]
;[eval exp="sf.HEV205 = 1"]
;[eval exp="sf.HEV206 = 1"]
;[eval exp="sf.HEV207 = 1"]
;[eval exp="sf.HEV208 = 1"]
;[eval exp="sf.HEV902 = 1"]
;[eval exp="sf.HEV209 = 1"]
;[eval exp="sf.HEV210 = 1"]
;[eval exp="sf.HEV212 = 1"]
;[eval exp="sf.HEV213 = 1"]
;[eval exp="sf.HEV214 = 1"]
;[eval exp="sf.HEV215 = 1"]
;[eval exp="sf.HEV216 = 1"]
;[eval exp="sf.HEV217 = 1"]
;[eval exp="sf.HEV218 = 1"]
;[eval exp="sf.HEV114 = 1"]
;[eval exp="sf.HEV115 = 1"]
;[eval exp="sf.HEV116 = 1"]
;[eval exp="sf.HEV108 = 1"]
;[eval exp="sf.HEV401 = 1"]
;[eval exp="sf.HEV110 = 1"]
;[eval exp="sf.HEV111 = 1"]
;[eval exp="sf.HEV117 = 1"]
;[eval exp="sf.HEV601 = 1"]
;[eval exp="sf.HEV901 = 1"]
;[eval exp="sf.HEV602 = 1"]
;[eval exp="sf.HEV904 = 1"]
;[eval exp="sf.HEV604 = 1"]
;[eval exp="sf.HEV605 = 1"]
;[eval exp="sf.HEV606 = 1"]
;[eval exp="sf.HEV607 = 1"]
;[eval exp="sf.HEV608 = 1"]
;[eval exp="sf.HEV609 = 1"]
;[eval exp="sf.HEV610 = 1"]
;[eval exp="sf.HEV611 = 1"]
;[eval exp="sf.HEV612 = 1"]
;[eval exp="sf.HEV801 = 1"]
;[eval exp="sf.HEV802 = 1"]
;[eval exp="sf.HEV803 = 1"]
;[eval exp="sf.HEV804 = 1"]
;[eval exp="sf.HEV805 = 1"]
;[eval exp="sf.HEV806 = 1"]
;[eval exp="sf.HEV701 = 1"]
;[eval exp="sf.HEV702 = 1"]
;[eval exp="sf.HEV006 = 1"]
;[eval exp="sf.HEV911 = 1"]
;[eval exp="sf.HEV911_ = 1"]

;[eval exp="sf.HEV912 = 1"]
;[eval exp="sf.HEV913 = 1"]
;[eval exp="sf.NEV001 = 1"]
;[eval exp="sf.NEV002 = 1"]
;[eval exp="sf.NEV003 = 1"]
;[eval exp="sf.NEV004 = 1"]
;[eval exp="sf.NEV005 = 1"]
;[eval exp="sf.NEV007 = 1"]
;[eval exp="sf.NEV008 = 1"]
;[eval exp="sf.NEV010 = 1"]
;[eval exp="sf.NEV101 = 1"]
;[eval exp="sf.NEV103 = 1"]
;[eval exp="sf.NEV207 = 1"]
;[eval exp="sf.NEV208 = 1"]
;[eval exp="sf.NEV209 = 1"]
;[eval exp="sf.NEV300 = 1"]
;[eval exp="sf.NEV500 = 1"]
;[eval exp="sf.NEV601 = 1"]
;[eval exp="sf.NEV701 = 1"]
;[eval exp="sf.NEV800 = 1"]
;[eval exp="sf.cut009 = 1"]
...
;		[locate x="&tf.b_pageX[3]" y="&tf.b_pageY[3]"][button graphic="page04"    target=*CDMODE再描画 exp="sf.CG_page = 4"]
;		[locate x="&tf.b_pageX[4]" y="&tf.b_pageY[4]"][button graphic="page05"    target=*CDMODE再描画 exp="sf.CG_page = 5"]
;		[locate   x="&tf.b_pageX[5]"   y="&tf.b_pageY[5]"][button graphic="page" target=*CDMODE再描画 exp="sf.CG_page = 6"]
;		[image left="&tf.b_pageX[5]" top="&tf.b_pageY[5]" storage="page06" layer=1 page=fore visible=true clipleft="&sf.page_clipleft" cliptop="&sf.page_cliptop" clipwidth="&sf.page_clipwidth" clipheight="&sf.page_clipheight" opacity=255]
;	[locate x="&tf.b_pageX[6]" y="&tf.b_pageY[6]"][button graphic="page7"    target=*CDMODE再描画 exp="sf.CG_page = 7"]
;	[locate x="&tf.b_pageX[7]" y="&tf.b_pageY[7]"][button graphic="page8"    target=*CDMODE再描画 exp="sf.CG_page = 8"]
