...
;play中のBGMを確定
[if    exp="f.playbgmname == 'bgm004'"][eval exp="tf.bgm_num =  1"]
[elsif exp="f.playbgmname == 'bgm005'"][eval exp="tf.bgm_num =  2"]
[elsif exp="f.playbgmname == 'bgm009'"][eval exp="tf.bgm_num =  3"]
[elsif exp="f.playbgmname == 'bgm010'"][eval exp="tf.bgm_num =  4"]
[elsif exp="f.playbgmname == 'bgm011'"][eval exp="tf.bgm_num =  5"]
[elsif exp="f.playbgmname == 'bgm012'"][eval exp="tf.bgm_num =  6"]
[elsif exp="f.playbgmname == 'bgmED001'"][eval exp="tf.bgm_num =  7"]
[elsif exp="f.playbgmname == 'm05'"][eval exp="tf.bgm_num =  8"]
[elsif exp="f.playbgmname == 'm01'"][eval exp="tf.bgm_num =  9"]
[elsif exp="f.playbgmname == 'm02'"][eval exp="tf.bgm_num = 10"]
[elsif exp="f.playbgmname == 'm04'"][eval exp="tf.bgm_num = 11"]
[elsif exp="f.playbgmname == 'm03'"][eval exp="tf.bgm_num = 12"]
[elsif exp="f.playbgmname == 'm06'"][eval exp="tf.bgm_num = 13"]
[elsif exp="f.playbgmname == '熱砂_Extreme'"][eval exp="tf.bgm_num = 14"]
[elsif exp="f.playbgmname == 'bgm018'"][eval exp="tf.bgm_num = 15"]
[endif]
...
;ボタンbgm12
[locate x="&tf.sound_x[12]" y="&tf.sound_y[12]"]
[if exp="tf.bgm_num == 12"]
	[button graphic="bgm"         target=*bgm12 exp="tf.bgm_num = 12" recthit=true]
	[image left="&tf.sound_x[12]" top="&tf.sound_y[12]" storage="&sf.bgm12_bt" layer=1 page=fore visible=true clipleft="&sf.bgm_clipleft" cliptop="&sf.bgm_cliptop" clipwidth="&sf.bgm_clipwidth" clipheight="&sf.bgm_clipheight" opacity=255]
[else]
	[button graphic="&sf.bgm12_bt"         target=*bgm12 exp="tf.bgm_num = 12" recthit=false]
[endif]

;ボタンbgm13
[locate x="&tf.sound_x[13]" y="&tf.sound_y[13]"]
[if exp="tf.bgm_num == 13"]
	[button graphic="bgm"         target=*bgm13 exp="tf.bgm_num = 12" recthit=true]
	[image left="&tf.sound_x[13]" top="&tf.sound_y[13]" storage="&sf.bgm13_bt" layer=1 page=fore visible=true clipleft="&sf.bgm_clipleft" cliptop="&sf.bgm_cliptop" clipwidth="&sf.bgm_clipwidth" clipheight="&sf.bgm_clipheight" opacity=255]
[else]
	[button graphic="&sf.bgm13_bt"         target=*bgm13 exp="tf.bgm_num = 13" recthit=false]
[endif]

;ボタンbgm14
[locate x="&tf.sound_x[14]" y="&tf.sound_y[14]"]
[if exp="tf.bgm_num == 14"]
	[button graphic="bgm"         target=*bgm14 exp="tf.bgm_num = 14" recthit=true]
	[image left="&tf.sound_x[14]" top="&tf.sound_y[14]" storage="&sf.bgm14_bt" layer=1 page=fore visible=true clipleft="&sf.bgm_clipleft" cliptop="&sf.bgm_cliptop" clipwidth="&sf.bgm_clipwidth" clipheight="&sf.bgm_clipheight" opacity=255]
[else]
	[button graphic="&sf.bgm14_bt"         target=*bgm14 exp="tf.bgm_num = 14" recthit=false]
[endif]

;ボタンbgm15
[locate x="&tf.sound_x[15]" y="&tf.sound_y[15]"]
[if exp="tf.bgm_num == 15"]
	[button graphic="bgm"         target=*bgm15 exp="tf.bgm_num = 15" recthit=true]
	[image left="&tf.sound_x[15]" top="&tf.sound_y[15]" storage="&sf.bgm15_bt" layer=1 page=fore visible=true clipleft="&sf.bgm_clipleft" cliptop="&sf.bgm_cliptop" clipwidth="&sf.bgm_clipwidth" clipheight="&sf.bgm_clipheight" opacity=255]
[else]
