;//¡ƒuƒƒbƒN‚Q‚O‚S‚U‚OFw•ö‚ê‚ä‚­A‰Ô‚Ñ‚çx

*westtown_zap_20460_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤westtown_zap_20460'"]
;[debug_win_end]
