;//¡ƒuƒƒbƒN‚Q‚O‚O‚P‚OFw“Œ“x

*westtown_zap_20010_TOP
;[debug_win]
;[eval exp="f.nowfile = '‚È‚¤westtown_zap_20010'"]
;[debug_win_end]

;//YWest-zap01
;//ƒuƒƒbƒN‚Q‚O‚O‚P‚O
;ƒtƒ[[eval exp="sf.g_West_zap01 = 1"]
;//ŸFlowFwesttown‚P
...
;//š‚a‚fFƒGƒ“ƒgƒ‰ƒ“ƒXC
;//—FƒGƒ“ƒgƒ‰ƒ“ƒX

[bg storage="bg06b"][trans_c cross time=1000]

;êŠ<ImageLoad 6,place05.bmp><ImagePos 6,1000,5>
;êŠ<ImageMove 6,30,608,5,OFF,‚˜,‚˜>

;//SEFƒKƒ‰ƒX‚ÌŠ„‚ê‚é‰¹iHj
;//SEFÔ‚ÌÕ“Ë‰¹iHj

[se0 storage="SE37"]
[se1 storage="SE38"]

;//‰æ–ÊŒø‰ÊFŒƒ‚µ‚­—h‚ê‚éiHj
